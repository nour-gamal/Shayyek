...
function ForgetPassword() {
    ...
    return (
        <div className="ForgetPassword">
 		...
 		<Container>
		 <AuthHeader title={currentLocal.login.forgetPasswordTitle}  login="login"/>
        ...
        <Modal
          ...
          >
            <div className="modalBody text-center">
              ...
              <p className="f-17 mobileNumber pb-3">Verification Link Sent Successfully 
			  <br/>
			  To {emailStateLetter}*****@{domain}</p>
			  <p className="checkMobile f-14 pb-3">Check Your Mail to Reset Your Password</p>
