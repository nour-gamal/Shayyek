...
export const governmentList = (languageId,countryId ,onSuccess, onFail, reqAuth = true) => {
...
export const getAccountType= (languageId ,onSuccess, onFail, reqAuth = true) => {
  const path = `api/Account/GetAccountTypes?languageId=${languageId}`;
  GetResource(path, onSuccess, onFail, reqAuth);
};
export const getCompanyType= (languageId ,onSuccess, onFail, reqAuth = true) => {
  const path = `api/Company/GetCompanyTypes?languageId=${languageId}`;
  GetResource(path, onSuccess, onFail, reqAuth);
};
export const register= (body ,onSuccess, onFail, reqAuth = true) => {
