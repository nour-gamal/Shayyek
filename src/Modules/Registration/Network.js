...
export const CompanyList = (languageId, onSuccess, onFail, reqAuth) => {
...
export const countryList = (languageId, onSuccess, onFail, reqAuth) => {
...
export const getWork = (language, onSuccess, onFail, reqAuth) => {
	const path = `api/Account/GetCategoriesWithChilds?language=${language}`;
	GetResource(path, onSuccess, onFail, reqAuth);
};
export const getRole = (languageId, onSuccess, onFail, reqAuth) => {
	const path = `api/Account/GetRoles?languageId=${languageId}`;
	GetResource(path, onSuccess, onFail, reqAuth);
};
export const getAccountType = (languageId, onSuccess, onFail, reqAuth) => {
	const path = `api/Account/GetAccountTypes?languageId=${languageId}`;
	GetResource(path, onSuccess, onFail, reqAuth);
};
export const getCompanyType = (languageId, onSuccess, onFail, reqAuth) => {
	const path = `api/Company/GetCompanyTypes?languageId=${languageId}`;
	GetResource(path, onSuccess, onFail, reqAuth);
};
export const register = (body, onSuccess, onFail, reqAuth, formData) => {
