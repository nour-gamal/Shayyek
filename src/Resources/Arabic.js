export const ar = {
	...
	home: {
		...
		contentOfTransparency:".هناك دائمًا عامل خطر يتعلق بتقييم الموردين الجدد ومراجعتهم. إن نظرة عامة للأسعار المتشابهة في السوق ومقاييس الموردين تجعل عملية صنع القرار مستنيرة أكثر من أي وقت مضى",
		accountability:"المسؤلية",
contentOfAcountability:".إنها سوق كبيرة بلا مستودع مركزي حقيقي لأداء المقاول أو المورد. نحن ملتزمون بتقديم أفضل تجربة شراء ممكنة لك من خلال التحسين المستمر لشبكتنا المعتمدة من الموردين وأدوات لوحة القيادة الذكية",
optimizedProcess:"عملية محسّنة",
contentOfoptimizedProcess:".إن عملية تحديد المصادر - التقييم - التفاوض - اتخاذ القرار هي مهمة شاقة تستغرق وقتًا طويلاً والتي غالبًا ما تحتاج إلى تكرارها عدة مرات مع القليل من المعلومات الداعمة للسوق. يؤدي ربط جميع الأطراف من خلال منصة مؤتمتة إلى زيادة موثوقية النتيجة مع تبسيط توفير الوقت والتكلفة"	
},
};
