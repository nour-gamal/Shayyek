export const en = {
  ...
  profilePage: {
    ...
    didYouWorkWith: "Have you worked with",
    rateIt: "before? Review it below:",
    rateValidation: 'Please answer all the questions',
    whatsapp: "WhatsApp",
    copyLink: "Copy link",
  ...
  buyerHome: {
    ...
    confirmDeleteEmployee: "Are you sure you want to delete the profile?",
